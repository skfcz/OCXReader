 ...
 * STEP/IGES filetype is determined automatically by filename extension - see
 * STEPorIGESReader().
 *
 * Returns:
 ...
 * STEPControl_Reader()
 * - If filename ends with ".iges" or ".igs" (case-insensitive), it will use
 * IGESControl_Reader()
 *
...
/**
 * Like STEPorIGESReader(), but ignores the filename and always uses a
